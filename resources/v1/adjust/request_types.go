...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1NameAdjustXgafvEnum]     `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                              `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1NameAdjustAltEnum]       `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1AdjustDeveloperBalanceRequest `json:"data"`
}
