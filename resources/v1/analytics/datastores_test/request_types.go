...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentAnalyticsDatastoresTestXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                             `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentAnalyticsDatastoresTestAltEnum]   `json:"alt,omitempty"`
