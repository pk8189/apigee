...
type ListRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.GetV1ParentAppsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                         `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.GetV1ParentAppsAltEnum]   `json:"alt,omitempty"`
	...
	IncludeCred    nullable.Nullable[bool]                           `json:"includeCred,omitempty"`
	Key            nullable.Nullable[string]                         `json:"key,omitempty"`
	KeyStatus      nullable.Nullable[string]                         `json:"keyStatus,omitempty"`
	...
	Rows           nullable.Nullable[string]                         `json:"rows,omitempty"`
	ShallowExpand  nullable.Nullable[bool]                           `json:"shallowExpand,omitempty"`
...
type CreateRequest struct {
	Parent         string                                             `json:"parent"`
	QueryXgafv     nullable.Nullable[types.PostV1ParentAppsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                          `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentAppsAltEnum]   `json:"alt,omitempty"`
	Callback       nullable.Nullable[string]                          `json:"callback,omitempty"`
	Fields         nullable.Nullable[string]                          `json:"fields,omitempty"`
	Key            nullable.Nullable[string]                          `json:"key,omitempty"`
	OauthToken     nullable.Nullable[string]                          `json:"oauthToken,omitempty"`
	...
	UploadType     nullable.Nullable[string]                          `json:"uploadType,omitempty"`
	UploadProtocol nullable.Nullable[string]                          `json:"uploadProtocol,omitempty"`
	Data           types.GoogleCloudApigeeV1DeveloperApp              `json:"data"`
}
