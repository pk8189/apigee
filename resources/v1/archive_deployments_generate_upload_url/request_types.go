...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentArchiveDeploymentsGenerateUploadUrlXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                                         `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentArchiveDeploymentsGenerateUploadUrlAltEnum]   `json:"alt,omitempty"`
