...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentCanaryevaluationsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                       `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentCanaryevaluationsAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1CanaryEvaluation                       `json:"data"`
}
