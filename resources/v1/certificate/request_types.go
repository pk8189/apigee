...
type ListRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.GetV1NameCertificateXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                              `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.GetV1NameCertificateAltEnum]   `json:"alt,omitempty"`
