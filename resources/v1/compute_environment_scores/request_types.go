...
type CreateRequest struct {
	...
	QueryXgafv         nullable.Nullable[types.PostV1ProfileEnvironmentComputeEnvironmentScoresXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken        nullable.Nullable[string]                                                          `json:"accessToken,omitempty"`
	Alt                nullable.Nullable[types.PostV1ProfileEnvironmentComputeEnvironmentScoresAltEnum]   `json:"alt,omitempty"`
	...
	Data               types.GoogleCloudApigeeV1ComputeEnvironmentScoresRequest                           `json:"data"`
}
