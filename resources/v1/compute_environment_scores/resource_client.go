...
package compute_environment_scores
...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (types.GoogleCloudApigeeV1ComputeEnvironmentScoresResponse, error) {
	// build & send request (keep comment for code generation)

	// URL formatting
	joined, err := url.JoinPath(c.coreClient.BaseURL, "/v1/"+sdkcore.FmtStringParam(request.ProfileEnvironment)+":computeEnvironmentScores")
	if err != nil {
		return types.GoogleCloudApigeeV1ComputeEnvironmentScoresResponse{}, err
	}
	...
	if resp.StatusCode >= 300 {
		return types.GoogleCloudApigeeV1ComputeEnvironmentScoresResponse{}, sdkcore.NewApiError(*req, *resp, body)
	}
	var bodyData types.GoogleCloudApigeeV1ComputeEnvironmentScoresResponse
