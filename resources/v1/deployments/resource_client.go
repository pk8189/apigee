...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (types.GoogleCloudApigeeV1Deployment, error) {
	// build & send request (keep comment for code generation)

	// URL formatting
	joined, err := url.JoinPath(c.coreClient.BaseURL, "/v1/"+sdkcore.FmtStringParam(request.Name)+"/deployments")
	if err != nil {
		return types.GoogleCloudApigeeV1Deployment{}, err
	}
	...
	serviceAccount, err := request.ServiceAccount.Value()
	if err != nil {
		sdkcore.AddQueryParam(params, "serviceAccount", serviceAccount, false)
	}
	...
	if resp.StatusCode >= 300 {
		return types.GoogleCloudApigeeV1Deployment{}, sdkcore.NewApiError(*req, *resp, body)
	}
	var bodyData types.GoogleCloudApigeeV1Deployment
...
func (c *Client) Delete(request DeleteRequest, reqModifiers ...RequestModifier) (map[string]interface{}, error) {
	...
	sequencedRollout, err := request.SequencedRollout.Value()
	if err != nil {
		sdkcore.AddQueryParam(params, "sequencedRollout", sequencedRollout, false)
	}
	uploadType, err := request.UploadType.Value()
	if err != nil {
		sdkcore.AddQueryParam(params, "uploadType", uploadType, false)
