...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1NameDeploymentsGenerateDeployChangeReportXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                                         `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1NameDeploymentsGenerateDeployChangeReportAltEnum]   `json:"alt,omitempty"`
