...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentEnvironmentsXgafvEnum]     `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                      `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentEnvironmentsAltEnum]       `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1SecurityProfileEnvironmentAssociation `json:"data"`
}
