...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1NameExpireXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                          `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1NameExpireAltEnum]   `json:"alt,omitempty"`
