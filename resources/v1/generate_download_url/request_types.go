...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1NameGenerateDownloadUrlXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                       `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1NameGenerateDownloadUrlAltEnum]   `json:"alt,omitempty"`
