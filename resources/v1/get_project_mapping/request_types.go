...
type ListRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.GetV1NameGetProjectMappingXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                    `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.GetV1NameGetProjectMappingAltEnum]   `json:"alt,omitempty"`
