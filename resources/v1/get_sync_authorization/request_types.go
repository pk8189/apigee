...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1NameGetSyncAuthorizationXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                        `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1NameGetSyncAuthorizationAltEnum]   `json:"alt,omitempty"`
