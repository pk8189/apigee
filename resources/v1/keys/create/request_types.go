...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentKeysCreateXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentKeysCreateAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1DeveloperAppKey                 `json:"data"`
}
