...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentKeyvaluemapsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                  `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentKeyvaluemapsAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1KeyValueMap                       `json:"data"`
}
