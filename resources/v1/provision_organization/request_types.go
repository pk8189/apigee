...
package provision_organization
...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ProjectProvisionOrganizationXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                            `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ProjectProvisionOrganizationAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1ProvisionOrganizationRequest                `json:"data"`
}
