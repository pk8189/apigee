...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentReferencesXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentReferencesAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1Reference                       `json:"data"`
}
