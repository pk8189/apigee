...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1InstanceReportStatusXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                    `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1InstanceReportStatusAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1ReportInstanceStatusRequest         `json:"data"`
}
