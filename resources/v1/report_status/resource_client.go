...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (map[string]interface{}, error) {
	// build & send request (keep comment for code generation)

	// URL formatting
	joined, err := url.JoinPath(c.coreClient.BaseURL, "/v1/"+sdkcore.FmtStringParam(request.Instance)+":reportStatus")
	if err != nil {
