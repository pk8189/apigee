...
type ListRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.GetV1ParentSecurityIncidentsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                      `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.GetV1ParentSecurityIncidentsAltEnum]   `json:"alt,omitempty"`
