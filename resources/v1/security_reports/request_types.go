...
type ListRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.GetV1ParentSecurityReportsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                    `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.GetV1ParentSecurityReportsAltEnum]   `json:"alt,omitempty"`
...
type CreateRequest struct {
	Parent         string                                                        `json:"parent"`
	QueryXgafv     nullable.Nullable[types.PostV1ParentSecurityReportsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                     `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentSecurityReportsAltEnum]   `json:"alt,omitempty"`
	Callback       nullable.Nullable[string]                                     `json:"callback,omitempty"`
	Fields         nullable.Nullable[string]                                     `json:"fields,omitempty"`
	Key            nullable.Nullable[string]                                     `json:"key,omitempty"`
	OauthToken     nullable.Nullable[string]                                     `json:"oauthToken,omitempty"`
