...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1OrgenvSecurityStatsQueryTabularStatsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                                    `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1OrgenvSecurityStatsQueryTabularStatsAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1QueryTabularStatsRequest                            `json:"data"`
}
