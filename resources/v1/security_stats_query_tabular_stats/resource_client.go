...
package security_stats_query_tabular_stats
...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (types.GoogleCloudApigeeV1QueryTabularStatsResponse, error) {
	// build & send request (keep comment for code generation)

	// URL formatting
	joined, err := url.JoinPath(c.coreClient.BaseURL, "/v1/"+sdkcore.FmtStringParam(request.Orgenv)+"/securityStats:queryTabularStats")
	if err != nil {
		return types.GoogleCloudApigeeV1QueryTabularStatsResponse{}, err
	}
	...
	if resp.StatusCode >= 300 {
		return types.GoogleCloudApigeeV1QueryTabularStatsResponse{}, sdkcore.NewApiError(*req, *resp, body)
	}
	var bodyData types.GoogleCloudApigeeV1QueryTabularStatsResponse
