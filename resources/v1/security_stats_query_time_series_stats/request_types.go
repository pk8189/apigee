...
type CreateRequest struct {
	Orgenv         string                                                                          `json:"orgenv"`
	QueryXgafv     nullable.Nullable[types.PostV1OrgenvSecurityStatsQueryTimeSeriesStatsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                                       `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1OrgenvSecurityStatsQueryTimeSeriesStatsAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1QueryTimeSeriesStatsRequest                            `json:"data"`
}
