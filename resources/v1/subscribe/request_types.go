...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentSubscribeXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                               `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentSubscribeAltEnum]   `json:"alt,omitempty"`
