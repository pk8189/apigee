...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentTargetserversXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                   `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentTargetserversAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1TargetServer                       `json:"data"`
}
