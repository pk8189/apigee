...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ResourceTestIamPermissionsXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                          `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ResourceTestIamPermissionsAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleIamV1TestIamPermissionsRequest                         `json:"data"`
}
