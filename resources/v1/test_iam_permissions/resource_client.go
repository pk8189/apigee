...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (types.GoogleIamV1TestIamPermissionsResponse, error) {
	// build & send request (keep comment for code generation)

	// URL formatting
	joined, err := url.JoinPath(c.coreClient.BaseURL, "/v1/"+sdkcore.FmtStringParam(request.Resource)+":testIamPermissions")
	if err != nil {
		return types.GoogleIamV1TestIamPermissionsResponse{}, err
	}
	...
	if resp.StatusCode >= 300 {
		return types.GoogleIamV1TestIamPermissionsResponse{}, sdkcore.NewApiError(*req, *resp, body)
	}
	var bodyData types.GoogleIamV1TestIamPermissionsResponse
