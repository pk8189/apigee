...
type CreateRequest struct {
	...
	QueryXgafv     nullable.Nullable[types.PostV1ParentUnsubscribeXgafvEnum] `json:"queryXgafv,omitempty"`
	AccessToken    nullable.Nullable[string]                                 `json:"accessToken,omitempty"`
	Alt            nullable.Nullable[types.PostV1ParentUnsubscribeAltEnum]   `json:"alt,omitempty"`
	...
	Data           types.GoogleCloudApigeeV1Subscription                     `json:"data"`
}
