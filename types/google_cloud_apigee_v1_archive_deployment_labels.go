...
type GoogleCloudApigeeV1ArchiveDeploymentLabels struct {
	AdditionalProperties map[string]string `json:"-"`
}

func (x *GoogleCloudApigeeV1ArchiveDeploymentLabels) UnmarshalJSON(data []byte) error {
	...
	type _GoogleCloudApigeeV1ArchiveDeploymentLabels GoogleCloudApigeeV1ArchiveDeploymentLabels // type alias avoids infinite recursion
	var unmarshaled _GoogleCloudApigeeV1ArchiveDeploymentLabels
	...
	*x = GoogleCloudApigeeV1ArchiveDeploymentLabels(unmarshaled)

	return nil
}

func (x GoogleCloudApigeeV1ArchiveDeploymentLabels) MarshalJSON() ([]byte, error) {
	// this type might have additional properties of type string
	// to handle this scenario we must flatten these properties while marshalling
	type _GoogleCloudApigeeV1ArchiveDeploymentLabels GoogleCloudApigeeV1ArchiveDeploymentLabels // type alias avoids infinite recursion
	var toMarshal = _GoogleCloudApigeeV1ArchiveDeploymentLabels(x)
